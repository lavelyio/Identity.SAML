    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<Saml2Configuration>(saml2Configuration =>
            {
                ...
                //saml2Configuration.DecryptionCertificate = CertificateUtil.Load(AppEnvironment.MapToPhysicalFilePath(Configuration["Saml2.DecryptionCertificate"]), Configuration["Saml2:SigningCertificatePassword"]);
            });
