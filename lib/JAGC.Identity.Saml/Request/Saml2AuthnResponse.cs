using Schemas = JAGC.Identity.Saml.Schemas;
using JAGC.Identity.Saml.Tokens;
using System;
using System.Linq;
...
using JAGC.Identity.Saml.Extensions;
using static JAGC.Identity.Saml.Request.Saml2Response;
#if NETFULL
...
namespace JAGC.Identity.Saml.Request
{
    /// <summary>
    ...
    public class Saml2AuthnResponse : Saml2Response
    {
        ...
        private Saml2SecurityToken ReadSecurityToken(XmlNode assertionElement)
        {
            ...
            {
                return (Saml2SecurityToken)Saml2SecurityTokenHandler.ReadToken(reader);
            }
        }
